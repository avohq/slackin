...
export default function splash ({
  ...
  let div = dom(
    ...
    dom(`script src=${path}assets/amplitude.js`),
    dom(`script src=${path}assets/avo-assert-js.js`),
    dom(`script src=${path}assets/avo-amplitude-js.js`),
    dom(`script src=${path}assets/analytics.js`),
