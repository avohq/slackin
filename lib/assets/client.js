...
body.addEventListener('submit', function (ev) {
  ...
  invite(
    ...
    function (err, msg) {
      // console.log('callback', err, msg, gcaptcha_response.value)
      if (err) {
        analytics.slackInviteRequested(
...
window.addEventListener(
  'load',
  function () {
    // console.log('analyticsState', analyticsState)
    analytics.slackRegistryOpened(analyticsState.total, analyticsState.active)
  },
  false
)
